...
/* main thread */ &init_thread.thread \
}
...
extern void sleep_on(struct thread_struct ** q);
extern void interruptible_sleep_on(struct thread_struct ** q);
extern void wake_up(struct thread_struct ** q);
